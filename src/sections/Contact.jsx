               ...
               <InnerContainer>
                   <QuestionHeader>
                       Having an Idea/Project in mind?
                        ...
                        <ContactContainer>
                            <div ><Button  className="btn btn-primary p-3"><AiOutlineMail/><a style={{color:"inherit",textDecoration:"none"}} href="mailto:suganyajap@gmail.com">suganyajap@gmail.com</a></Button></div>
                            <div ><Button  className="btn btn-primary p-3"><FiSmartphone/><a style={{color:"inherit",textDecoration:"none"}} href="tel:+919035065446">+91-9035065446</a></Button></div>
                            <div ><Button  className="btn btn-primary p-3"><FiMapPin/>Bangalore,Karnataka</Button></div>
                        </ContactContainer>
               </InnerContainer>
            </Container>
        </div>
